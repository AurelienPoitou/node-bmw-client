...
async function handleSocketConnection(socketConnection) {
	...
	// socketConnection.on('websocket-dash-subscribe', data => {
	// 	log.lib(`socket.io websocket-dash-subscribe ${data}`);
	// });

	// socketConnection.on('websocket-dash-unsubscribe', data => {
	// 	log.lib(`socket.io websocket-dash-unsubscribe ${data}`);
	// });
